    ...
    <>
      <section className="pt-8">
        ...
        <div className="mx-2 md:mx-40 lg:mx-60">
          ...
          <div className="mx-auto space-x-2 my-2 grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-9 gap-2">
            <button className="bg-gray-600 text-white rounded-md p-2 flex justify-center items-center"
            onClick={boldText}
            >
              <FaBold />
            </button>
